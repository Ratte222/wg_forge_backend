...
namespace DAL.Migrations
{
    ...
    [Migration("20210713074452_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatCatOwner", b =>
                {
            ...
            modelBuilder.Entity("CatCatOwner", b =>
                {
                    b.HasOne("DAL.Entities.CatOwner", null)
                        .WithMany()
                        .HasForeignKey("CatOwnersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DAL.Entities.Cat", null)
                        .WithMany()
